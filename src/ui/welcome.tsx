  ...
  return (
    <Box flexDirection="column" marginBottom={1}>
      ...
      <Box>
        ...
        <Text color={POKE.blue} bold>Poke Code</Text>
        <Text color={POKE.dim}>{' v'}{version}</Text>
        <Text color={POKE.dim}>{' ───────────────────────────────────────────────'}</Text>
      </Box>
      ...
      <Box flexDirection="row" gap={1} marginTop={1}>
        ...
        >
          ...
          {PALM_TREE.map((line, i) => (
            <Text key={`palm-${i}`} color={POKE.lightBlue}>{line}</Text>
          ))}
          <Text> </Text>
          <Text color={POKE.white} bold>  {greeting}</Text>
          <Text> </Text>
        ...
        <Box flexDirection="column" flexGrow={1}>
          ...
          <Box
            ...
            paddingY={1}
          >
            <Text color={POKE.blue} bold>Tools (local execution)</Text>
          ...
          <Box
            ...
            marginTop={0}
          >
            <Text color={POKE.blue} bold>Getting started</Text>
          ...
          {recentSessions.length > 0 && (
            <Box
              ...
              marginTop={0}
            >
              <Text color={POKE.blue} bold>Recent activity</Text>
